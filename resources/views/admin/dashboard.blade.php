            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-5 mb-4 mb-xl-0">
                  ...
                  <h4 class="font-weight-normal mb-0">{{ Auth::user()->name }},</h4>
                </div>
                <div class="col-12 col-xl-7">
                  <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div class="border-right pr-4 mb-3 mb-xl-0">
                      <p class="text-muted">Visitor</p>
                      <h4 class="mb-0 font-weight-bold">22</h4>
                    </div>
                    <div class="border-right pr-4 mb-3 mb-xl-0">
                      <p class="text-muted">Project Viewer</p>
                      <h4 class="mb-0 font-weight-bold">33</h4>
                    </div>
                    <div class="border-right pr-4 mb-3 mb-xl-0">
