  ...
  <div class="container-scroller">
	...
	@yield('content')
          ...
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2020 <a href="myapp://" target="_blank">sragenflorist.com</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
